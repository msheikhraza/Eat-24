...
class CustomDialogBoxforgetpass extends StatefulWidget {
  final  title, descriptions, text;
  final  img;

  const CustomDialogBoxforgetpass({ this.title, this.descriptions, this.text, this.img});

  @override
  _CustomDialogBoxState createState() => _CustomDialogBoxState();
}

class _CustomDialogBoxState extends State<CustomDialogBoxforgetpass> {
  @override
