...
class CustomDialogBoxlocation extends StatefulWidget {
  final  title, descriptions, text;
  final  img;

  const CustomDialogBoxlocation({ this.title, this.descriptions, this.text, this.img});

  @override
  _CustomDialogBoxState createState() => _CustomDialogBoxState();
}

class _CustomDialogBoxState extends State<CustomDialogBoxlocation> {
  @override
          ...
          Align(
            ...
            child: InkWell(
              child: Container(
                ...
                child: Center(
                  child: Text("Enable Location".toUpperCase() ,
                    style: TextStyle(
                        fontSize: 16,
                        color: Colors.white ,
                        letterSpacing: 0.18,
